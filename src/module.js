...
class oTweetBlot extends BlockEmbed {
...
oTweetBlot.blotName = 'otweet';
oTweetBlot.tagName = 'div';
oTweetBlot.className = 'ql-otweet';

Icon['otweet'] = oTweetBlot.icon();
...
Quill.register('formats/otweet', oTweetBlot);
